...
**Status 2026-09-05 (evening):** manual complete and reviewed — 16 assembly chapters (docs/manual/00–14, ~640 steps) + 12 printing chapters (docs/manual/print/, 27 plates / 134.3 h / 1940 g black + 308 g orange) + index/timeline with corrections log (docs/manual/00-index.md). Six-track review (conflicts, assembly vs sources, electronics vs sources, printing vs STL repos + PrusaSlicer 2.9.6/3.0, iPad usability, improvements) archived in review/2026-09-05/; all BLOCKER/MAJOR findings applied; R6-improvements.md holds the ranked backlog. Site: `./scripts/serve.sh` locally; GitHub Actions builds `--strict` + runs scripts/lint_manual.py and deploys to Pages on push to main. Bench-verify items are marked `(verify on bench)` in-chapter.

## Hardware

- **Prusa Core One+** — building with daughter, currently in-progress (as of 2026-09-05 was at Ch.6/step 33 of 58, ~55% through by time). Original kit purchased 2026-05-17 (Prusa order **1779051361**, $1,384.86: "CORE One+ kit Advanced Filtration + Camera BUNDLE" $1,109.00 + Prusament PLA Pearl Mouse 1kg clearance $24.99 + FedEx economy $179.99 + duties/tax; shipped 2026-05-18, FedEx). Frame is Gen 1; ordered the Gen 1→Gen 2 upgrade kit (order 1787919456, Aug 28, $212.43): GT1.5 belts/pulleys, Gen 2 heatbed expansion joints, nozzle wiper, spare nylon rivets; Gen 2 quick-release top cover sold separately, not included.
