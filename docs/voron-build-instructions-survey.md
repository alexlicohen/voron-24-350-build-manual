...
|---|---|---|---|---|
| **P00 Prep, inventory, rail prep, jigs** | 2.5–4.0 | *Jigs only, PLA on the Prusa:* `Tools/MGN9_rail_guide_x2`, `Tools/MGN12_rail_guide_x2`, `Tools/pulley_jig`, `Tools/bed_hole_marking_template_x1_Rev2`, `Tools/bottom_panel_template`, `Test_Prints/Heatset_Practice`, `Test_Prints/Voron_Design_Cube_v7` | — | ✅ (jigs are PLA, printable day one) |
...
| **P09 Electronics bay: DIN rails, ducts, board mounting, endstops, Pi** | 2.5–4.0 | `Electronics_Bay/wago_221-415_mount_3by5` only (everything else LDO-supplied printed) | P02 | 🟡 one small part |
...
|---|---|---|---|
| W1 | A/B belts tensioned before gantry squaring | Full de-tension + belt-clamp release; ~1.5 h | Gate P07 on P06's squaring sign-off |
