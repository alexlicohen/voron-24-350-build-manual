...
|---|---|---|
| `[a]_` | STL filename prefix: print in the **accent** colour — ASA Blue on this build. Every `[a]_` part is collected into batch B02 | [00.24](00-before-you-start.md#step-0024-file-naming-and-where-to-get-help-p56) |
...
| **Extrusion multiplier / flow** | The slicer's scaling of how much plastic is extruded, set by eye on the centre of a top surface, never from caliper readings. **Not** a size lever: Voron parts need no compensation beyond a good multiplier tune (Ellis), and never negative XY size compensation | [14.19](14-calibration.md#step-1419-extrusion-multiplier-flow-the-2-pass) |
