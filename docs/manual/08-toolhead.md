...
2. Otherwise solder **OUT to IN** along the chain, logo 1, right 2, left 3, every LED's wires exiting the same way.
...
1. Land the motor-end ring lug on a short screw into one of the NEMA14's two **free face holes**.
