...
Every printed part is made here, on a **Prusa Core One+** (on Gen 2 GT1.5 belts — the upgrade goes in before the first plate), in Prusament ASA Galaxy Black with a Prusament ASA Blue accent: 22 plates, 157.0 h, 1813 g black + 279 g blue — see [Plate plans](../print/plate-plans.md) for every diagram at a glance.

Begin with the [Gen 2 belt upgrade](print/B00-calibration-and-jigs.md#gen-2-first) the day that kit lands, and until then with [slicer setup](print/00-slicer-setup.md) and the `(pre-kit)` steps of Ch 00 — the [home page](../index.md) lists the order. The Voron kit is not expected until **late November to late December 2026**, so **all eleven print batches — 22 plates, the whole 157.0 h — go down before it arrives**, and [**Ch 00 — Before you start**](00-before-you-start.md) opens the day the cartons land with every bin already full.
...
**The whole run prints before the kit.** Rows 1–13 cover the Gen 2 belt upgrade and every batch in numeric order, B00 → B10 (row 3 is Ch 00a): 157.0 h ≈ 16 printer-days ≈ 3–4 weeks at two plate swaps a day. The bench work under them is Ch 00a and Ch 00's own pre-kit steps (00.23–00.32: the manual's front matter, the measurement log, the Discord questions — marked `(pre-kit)` so [Tonight](00-tonight.md) offers them), plus reading a chapter and sorting a batch into its bins as each plate comes off. Rows 15 onward are the build, and not one of them waits for a plate.

- **1 · Both** — **Gen 2 belt upgrade — the first job** · ~1 day wall clock · needs: the **Gen 1→Gen 2 upgrade kit** (Prusa order 1787919456) on the bench — not the Voron kit
    - *While it prints:* Nothing prints — the Prusa is apart. Dry the first black spool, read [00-slicer-setup](print/00-slicer-setup.md), confirm the sheet and glue
    - *Gate:* Tick list on its own page: [Gen 2 first](print/B00-calibration-and-jigs.md#gen-2-first) — firmware ≥ 6.8.1, Settings → Hardware → Edition → **Gen 2**, belts per the Prusa guide, re-tension, re-square, self-test and input shaper. The whole 157.0 h run then goes down on GT1.5
    - *Sessions:* —
- **2 · Print** — [B00 — Calibration & jigs](print/B00-calibration-and-jigs.md) · 4.0 h print · needs: the Gen 2 upgrade done (row 1)
...
- **13 · Print** — [B10 — Clicky-Clack door](print/B10-clicky-clack-door.md) · 5.7 h print · needs: B02 (`Handle`), B09; door swing decided
    ...
    - *Sessions:* 1 plate start
- **14 · Both** — **Gen 2 belt-upgrade pause, contingency only** · ~1 day wall clock · needs: the Gen 2 kit still not here when B00 starts, then arriving mid-run
    - *While it prints:* Nothing prints — the Prusa is apart
    - *Gate:* If the upgrade kit has not landed by **2026-10-15**, start B00 on Gen 1 and take this pause after B07, before B08. Firmware ≥ 6.8.1, re-tension, re-square, self-test + input shaper, then **re-print `Voron_Design_Cube_v7` and re-pass Gate A** before B08
    - *Sessions:* —
- **15 · Build** — [Ch 00 — Before you start](00-before-you-start.md) **KIT** · 2.5–4.0 · needs: the kit; bins for Ch 00 full (B00 `Heatset_Practice`, both rail guides)
    ...
    - *Sessions:* 7 × ~30 min
- **16 · Build** — [Ch 12 Part 1 — image the Pi, install Klipper/Moonraker/Mainsail](12-software.md) **KIT** · ~1.0 of Ch 12's 2.0–3.0 · needs: the Pi from carton 2 only — no hardware gate
    - *Gate:* Pi on the network, web UI up, bench-powered from USB-C
    - *Sessions:* 2 × ~30 min
- **17 · Build** — [Ch 01 — Frame](01-frame.md) **KIT 2P** · 2.5–4.0 · needs: Ch 00
    - *Gate:* Checkpoint 01: diagonals equal, frame square on the verified-flat counter
    - *Sessions:* 4 × ~30 min
- **18 · Build** — [Ch 02 — Z drives, Z idlers, Z rails, deck](02-z-drives.md) **KIT** · 4.25–6.25 · needs: Ch 01; bins for Ch 02 full (B00, B01, **B02-P1**, **B02-P3**)
    - *Gate:* Checkpoint 02: four Z carriages move freely, deck in, every set screw threadlocked on the flat
    - *Sessions:* 11 × ~30 min
- **19 · Build** — [Ch 03 — Build plate](03-build-plate.md) **KIT** · 1.5–2.5 · needs: Ch 01, Ch 02
    - *Gate:* Checkpoint 03: magnet applied **and** its bolt holes trimmed straight after, plate bolted, three cables hanging below deck
    - *Sessions:* 4 × ~30 min
- **20 · Build** — [Ch 04 — A/B drives and front idlers](04-ab-drives.md) **KIT** · 3.5–5.0 · needs: Ch 01; bins for Ch 04 full (B00 `pulley_jig`, **B02-P2**, B03)
    - *Gate:* Checkpoint 04: A = rear right, B = rear left; both pulley heights set with `pulley_jig`
    - *Sessions:* 6 × ~30 min
- **21 · Build** — [Ch 05 — Gantry](05-gantry.md) **KIT 2P** · 5.0–7.0 · needs: Ch 00 rails, Ch 04; bins for Ch 05 full (**B02-P3**, B04)
    - *Gate:* Checkpoint 05: titanium backers fitted **before** the XY joints are torqued (survey W2); X carriage runs full travel
    - *Sessions:* 12 × ~30 min
- **22 · Build** — [Ch 06 Part A — Z axis: hang the gantry, Z belts](06-z-axis-and-gantry-squaring.md#part-a-chapter-06-z-axis-mechanical) **KIT 2P lift** · 3.5–5.0 · needs: Ch 02, Ch 05; bins for Ch 06 full (B02, B05)
    - *Gate:* Checkpoint 06: gantry travels its full Z range by hand, four Z belts even by ear
    - *Sessions:* 8 × ~30 min
- **23 · Build** — [Ch 07 — A/B belts, provisional tension](07-ab-belts.md) **KIT** · 2.5–4.0 · needs: Ch 04, Ch 05, Ch 06 Part A; bins for Ch 07 full (B02, B03, B04, B05)
    - *Gate:* Checkpoint 07: both belts ~110 Hz and equal after moving the gantry — **provisional**, Ch 06b releases it again
    - *Sessions:* 5 × ~30 min
- **24 · Build** — [Ch 08 — Toolhead](08-toolhead.md) **KIT** · 3.0–4.5 · needs: Ch 05, Ch 07; bins for Ch 08 full (B02, B04, B06)
    - *Gate:* Checkpoint 08: inductive probe built and Klicky bagged, every toolhead connector seated, ESD ground lead on
    - *Sessions:* 10 × ~30 min
- **25 · Build** — [Ch 09 — Electronics bay](09-electronics-bay.md) **KIT** · 2.5–4.0 · needs: Ch 01–03, Ch 06, Ch 00a; bins for Ch 09 full (B07)
    - *Gate:* Checkpoint 09: DIN rails **left-to-right**, everything mounted, nothing wired yet
    - *Sessions:* 7 × ~30 min
- **26 · Build** — [Ch 10 — Wiring](10-wiring.md) **KIT** · 5.0–7.0 · needs: Ch 03, Ch 06, Ch 07, Ch 08, Ch 09; bins for Ch 10 full (B05, B07, B08 `mount.stl`, B02 `[a]_faceplate`) — the TFT module is built at 10.50
    - *Gate:* **LDO Checkpoint #1** — multimeter, machine unplugged. Hard gate: the bay does not close until it passes (survey W8)
    - *Sessions:* 14 × ~30 min
- **27 · Build** — [Ch 12 Part 2 — flash both MCUs, `printer.cfg` for a 350 Rev D+](12-software.md#step-1211-gate-power-the-bay-and-confirm-both-mcus-enumerate) **KIT** · the rest of 2.0–3.0 · needs: Ch 10
    - *Gate:* Checkpoint 12: toolboard ID reads `stm32g0b1xx` (survey W13); every 350 mm value uncommented (survey W14)
    - *Sessions:* 7 × ~30 min
- **28 · Build** — [Ch 11 Part A — skirts, bay fans, bottom panel, Z belt covers, Nevermore, spool, door hinges](11-skirts-panels-door.md#part-a-before-first-power-up) **KIT** · 3.0–4.0 · needs: Ch 10 Checkpoint #1, Ch 12 Part 2; bins for Ch 11 full (B02, B07, B08, B09, B10)
    - *Gate:* Bay closed. **Back, side and top panels and the door stay off** — Ch 13 and Ch 06b need to reach the gantry
    - *Sessions:* 12 × ~30 min
- **29 · Build** — [Ch 13 — Initial startup](13-initial-startup.md) **KIT** · 2.5–4.0 plus ~1 h cube print · needs: Ch 06 Part A, Ch 07, Ch 10, Ch 11 Part A, Ch 12
    - *Gate:* Checkpoint 13: `PROBE_ACCURACY` σ < 0.003 mm, QGL converged, Z=0 set, cube printed and kept
    - *Sessions:* 11 × ~30 min
- **30 · Build** — [Ch 06b — Gantry squaring, cold, and provisional tension](06-z-axis-and-gantry-squaring.md#part-b-chapter-06b-gantry-squaring) **KIT 2P** · ~1.0 · needs: Ch 13 Step 13.34
    ...
    - *Sessions:* 1 × ~30 min
- **31 · Build** — [Ch 11 Part B — back, side and top panels, Clicky-Clack door](11-skirts-panels-door.md#part-b-after-ch-13) **KIT** · 1.0–2.0 · needs: Ch 13, Ch 06b; bins for Ch 11 Part B full (B02 `Handle`, B09, B10)
    - *Gate:* Chamber reaches the 50–60 °C band with the door shut
    - *Sessions:* 5 × ~30 min
- **32 · Build** — [Ch 14 — Calibration and tuning: hot soak, final tension, re-check, then tune](14-calibration.md) **KIT** · 2.5–4.0 over 6–8 h · needs: Ch 13, Ch 06b, Ch 11 Part B (the chamber has to close for the soak)
...
**Row 1, and why the upgrade goes first.** The Voron kit is not expected before late November, and the Gen 1 → Gen 2 upgrade kit (Prusa order 1787919456) is due well before that — so there is no reason to lay down 157.0 h of ASA on GT2 belts and then change the machine under the parts. The conversion moves belts, pulleys, steps/mm and firmware together and ends in a re-tension, a re-square and a fresh Gate A cube: do it once, before B00, and every plate in the build is GT1.5.

**Row 14 is the contingency.** If the upgrade kit has still not arrived by **2026-10-15**, start B00 on Gen 1 rather than hold the run, and take the pause at the end of B07, before B08 — B08–B10 are 10 of the 22 plates and hold every surface anyone will ever look at ([print plan §8](../voron-print-plan.md#8-where-to-do-the-core-one-gen-2-belt-upgrade)). Second-best boundary is before B02, whose plate P1 carries the Stealthburner body.
...
| **(a) After the Prusa is running** | **≈ 3–4 calendar weeks of printing** — the Gen 2 upgrade, then 22 plates back to back. Starting early/mid October puts the last plate off the bed early/mid November, two to six weeks ahead of the kit |
...
Assumptions: 22 h/week of hands-on (2 h on each of five weekdays, 6 h on each of two weekend days), the Core One+ printing unattended overnight with about two plate swaps a day, no reprints beyond the plan's 24 % filament margin, the Gen 2 upgrade done before B00 rather than at row 14, and the kit landing between 2026-11-20 and 2026-12-24 — after the last plate is off the bed.
...
| [B08 — Skirts and front modules](print/B08-skirts-and-front-modules.md) | The 350 skirt set, front touchscreen module, grills and guards | 4 · 29.2 | Gate A — already on GT1.5; re-passed on a fresh cube only if the upgrade slipped to row 14 |
