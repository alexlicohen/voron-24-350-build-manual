...
| 24 | 2026-09-06 | **Each A/B belt is teeth-on at the return-side XY-joint idler.** A belt leaves the X carriage smooth-back-on its own joint's idler and comes back from the front idler teeth-on the other joint's 20T idler — by design (manual p.135/p.138 draw toothed idlers there). Never twist a belt to change which face touches an idler | Ch 07 intro and Step 07.23 Check, pre-fix ("smooth back on every plain stack") | [Ch 07 Steps 07.16 / 07.22 / 07.23](07-ab-belts.md); [Ch 05 Step 05.29](05-gantry.md) | Manual p.135 and p.138; Ch 05.29 — review F4 |
