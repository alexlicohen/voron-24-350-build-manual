...
<img class='mascot-panel off-glb' src='@mascot/mascot-gather.svg' alt='The raven with a tray of screws' width='96' height='96' loading='lazy' decoding='async'>

_Generated by `scripts/build_printables.py` — do not hand-edit._

All **22 plates**, **157.0 h**, **1813 g Galaxy Black + 279 g ASA Blue**, in print order (batches: B00 → B01 → B02 → B03 → B04 → B05 → B06 → B07 → B08 → B09 → B10). Every diagram is drawn from the committed PrusaSlicer project `slicer/plates/<id>.3mf` (`python3 slicer/build_plates.py --from-3mf`).
