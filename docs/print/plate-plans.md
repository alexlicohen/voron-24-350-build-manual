...
All **22 plates**, **157.1 h**, **1812 g Galaxy Black + 279 g Prusa Orange**, in print order (batches: B00 → B02 → B07 → B08 → B09 → B10 → B01 → B03 → B04 → B05 → B06). Every diagram is drawn from the committed PrusaSlicer project `slicer/plates/<id>.3mf` (`python3 slicer/build_plates.py --from-3mf`).
...
**B08-P3** · black · 4 parts · 9.5 h · 121 g · bins: 11-skirts · [Load step](../manual/print/B08-skirts-and-front-modules.md#step-b086-load-plate-b08-p3)
