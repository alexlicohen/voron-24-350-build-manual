...
<img class='mascot-panel off-glb' src='@mascot/mascot-gather.svg' alt='Revali with a tray of screws' width='96' height='96' loading='lazy' decoding='async'>

_Generated by `scripts/build_printables.py` — do not hand-edit._

All **22 plates** of the ASA run, **157.0 h**, **1813 g Galaxy Black + 279 g ASA Blue**, in print order (batches: B00 → B01 → B02 → B03 → B04 → B05 → B06 → B07 → B08 → B09 → B10), then B11, the bay ducting: **5 plates**, **25.0 h**, **348 g Jet Black PETG V0**, outside the run's totals. Every diagram is drawn from the committed PrusaSlicer project `slicer/plates/<id>.3mf` (`python3 slicer/build_plates.py --from-3mf`).
...
## Batch B02 — [Accent parts (blue)](../manual/print/B02-accent-parts-orange.md)
...
**B02-P2** · blue · 13 parts · 7.3 h · 93 g · bins: 04-A, 04-B, 11-fans, 11-door · [Load step](../manual/print/B02-accent-parts-orange.md#step-b024-load-plate-b02-p2)
...
**B02-P3** · blue · 29 parts · 7.6 h · 96 g · bins: 02-Z0, 02-Z1, 02-Z2, 02-Z3, 05-XY, 06-Z-joints, 08-CW2, 10-chains, 11-skirts, spare-alt · [Load step](../manual/print/B02-accent-parts-orange.md#step-b026-load-plate-b02-p3)
...
**B06-P1** · black · 19 parts · 12.1 h · 148 g · bins: 08-SB, 08-CW2, spare-alt · [Load step](../manual/print/B06-toolhead-sb-cw2-klicky.md#step-b062-load-plate-b06-p1)
...
## Batch B11 — [Bay ducting (PETG V0)](../manual/print/B11-bay-ducting.md)
